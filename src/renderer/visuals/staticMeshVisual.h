...
{
	class RenderSystem;
	class StaticMeshVisual : public Visual
	{
	public:
		StaticMeshVisual(RenderSystem& system, Engine::ObjectFactory& factory);
		~StaticMeshVisual();
		 ...
		 */
		void createMesh(const ZenConvert::PackedMesh& packedMesh);
	...
	private:
		 ...
		 */
		RAPI::RLogicalBuffer<WorldVertex>* m_pVertexBuffer;
